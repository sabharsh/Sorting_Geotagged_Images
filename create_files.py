...
#Creates CSV file with first column containing the time of the video in seconds and second column containing all the images within VIDEO_DISTANCE_RANGE of drone
...
#Creates CSV file with first column containing the name of the points of interest and second column containing all the images within POI_DISTANCE_RANGE of the respective POI 
